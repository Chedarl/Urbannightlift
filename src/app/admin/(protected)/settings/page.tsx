  ...
  return (
    <SettingsManager
      ...
      settings={{
        ...
        fareMinimumXaf: settings.fareMinimumXaf,
        fareIncludedKm: settings.fareIncludedKm,
        farePerKmXaf: settings.farePerKmXaf,
        fareErrandXaf: settings.fareErrandXaf,
        fareLateNightPercent: settings.fareLateNightPercent,
        fareLateNightFromHour: settings.fareLateNightFromHour,
        fareYellowPercent: settings.fareYellowPercent,
